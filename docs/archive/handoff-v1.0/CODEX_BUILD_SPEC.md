...
> **Auftrag an Codex:** Implementiere dieses Projekt vollständig als reproduzierbares, öffentlich vorzeigbares n8n-Portfolio-System. Nutze den bereitgestellten n8n-Connector zum tatsächlichen Erstellen, Konfigurieren, Testen und Bereitstellen der Workflows. Eine Sammlung von JSON-Dateien ohne nachgewiesene Ausführung ist kein fertiges Ergebnis. Arbeite die Meilensteine bis zur Abnahme ab. Trenne implementiert, lokal getestet, auf der Zielinstanz getestet und durch fehlende Zugriffe blockiert ausdrücklich voneinander. Benutze ausschließlich synthetische Unternehmensdaten.
