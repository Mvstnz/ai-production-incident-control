...
const stage2 = trigger({type: "n8n-nodes-base.webhook", version: 2.1, config: {"name": "Protected Recovery Test", "position": [540, 200], "parameters": {"httpMethod": "POST", "path": "apic-recovery", "authentication": "headerAuth", "responseMode": "lastNode", "options": {"allowedOrigins": "http://127.0.0.1:5173"}}, credentials: {"httpHeaderAuth": newCredential("APIC Webhook Intake")}}, output: [{}]});
